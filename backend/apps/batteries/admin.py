...
class DroneBatteryAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("serial_number", "name", "warehouse", "is_active")}),
        (
            _("Specifications"),
            {
                "fields": (
    ...
    def cycle_progress(self, obj):
        ...
        return format_html('<span style="color: {};">{} / {}</span>', color, obj.cycle_count, obj.max_cycles)
...
class BatteryChargingSessionAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("battery", "status", "charger_id", "charger_location")}),
        (_("Timing"), {"fields": ("started_at", "ended_at")}),
        (_("Charge Levels"), {"fields": ("start_charge_percent", "end_charge_percent")}),
        (
            _("Voltage"),
            {
...
class BatterySwapRecordAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("drone", "swap_reason", "swapped_at")}),
        (
            _("Batteries"),
            {
                "fields": (
