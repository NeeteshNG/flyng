...
class WarehouseAdmin(ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Settings", {"fields": ("timezone", "is_active")}),
    )
...
class WarehouseContactAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("warehouse", "name", "designation")}),
        ("Contact Information", {"fields": ("email", "phone_primary", "phone_secondary")}),
        ("Contact Type", {"fields": ("is_primary", "is_emergency", "is_active")}),
        (
            "Notes",
            {
                "fields": ("notes",),
...
class WarehouseZoneAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("warehouse", "name", "code", "description", "zone_type")}),
        ("Physical Properties", {"fields": ("floor_level", "area_sqft")}),
        (
            "Boundaries",
            {
        ...
        ("Operational Settings", {"fields": ("max_drones_allowed", "priority")}),
        ("Status", {"fields": ("is_active", "is_no_fly_zone")}),
    )
...
class GroundControlStationAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("zone", "name", "code", "description")}),
        (
            "Position",
            {
        ...
        ("Capacity", {"fields": ("max_drones",)}),
        ("Status", {"fields": ("status", "is_active", "last_heartbeat")}),
    )
...
class DroneWorkAreaAdmin(ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Operational Limits", {"fields": ("max_flight_speed_mps", "max_drones")}),
