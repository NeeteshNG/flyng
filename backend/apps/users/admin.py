...
class UserAdmin(BaseUserAdmin, ModelAdmin):
    ...
    readonly_fields = [
        'uuid', 'last_login', 'date_joined', 'created_at', 'updated_at',
        'failed_login_attempts', 'lockout_until', 'last_login_ip',
        'password_changed_at', 'two_factor_enabled',
    ]

    actions = [
        'activate_users', 'deactivate_users', 'mark_verified',
        'unlock_users', 'disable_2fa', 'force_password_change',
    ]
...
class TwoFactorAuthAdmin(ModelAdmin):
    ...
    ordering = ['-created_at']
    readonly_fields = [
        'user', 'secret_key', 'is_active', 'backup_codes_remaining',
        'verified_at', 'backup_codes_generated_at', 'created_at', 'updated_at',
    ]
    list_per_page = 50
...
class EmailChangeRequestAdmin(ModelAdmin):
    ...
    ordering = ['-created_at']
    readonly_fields = [
        'user', 'old_email', 'new_email', 'is_verified',
