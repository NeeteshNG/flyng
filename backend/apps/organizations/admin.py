...
class PlanAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "plan_type", "description", "is_active", "display_order")}),
        ("Pricing", {"fields": ("monthly_price", "annual_price")}),
        (
            "Resource Limits",
            {
                "fields": (
        ...
        ("API & Data", {"fields": ("api_rate_limit_per_minute", "data_retention_days")}),
    )
...
class OrganizationSettingsInline(admin.StackedInline):
    ...
    fieldsets = (
        ("Regional", {"fields": ("timezone", "date_format", "currency", "language")}),
        (
            "Inventory",
            {
                "fields": (
...
class OrganizationAdmin(ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Subscription", {"fields": ("plan", "trial_ends_at")}),
